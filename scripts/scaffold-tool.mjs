...
After scaffolding, register the tool in scripts/build.mjs, scripts/dev.mjs, apps/hub/hub.config.json (with a category from its "categories" list).`);
}
...
console.log('Register it in scripts/build.mjs, scripts/dev.mjs, apps/hub/hub.config.json (with a category from its "categories" list).');
